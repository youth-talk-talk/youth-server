    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(LOGIN_URL, SIGNUP_URL, ADMIN_LOGIN_URL, STATIC_RESOURCE, HEALTH_CHECK_URL).permitAll()
                        .requestMatchers(ADMIN_RESOURCE).hasRole("ADMIN") // 관리자 역할 필요 경로
